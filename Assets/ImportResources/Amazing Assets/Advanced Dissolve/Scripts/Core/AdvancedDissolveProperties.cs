    ...
    static public class AdvancedDissolveProperties
    {
        ...
        public class Cutout
        {
            ...
            public class Standard
            {
                public class IDs
                {
                    ...
                    public IDs(int ID)
                    {
                        ...
                        mapsTriplanarMappingSpace =
                            Shader.PropertyToID("_AdvancedDissolveCutoutStandardMapsTriplanarMappingSpace" + id);
                        mapsScreenSpaceUVScale =
                            Shader.PropertyToID("_AdvancedDissolveCutoutStandardMapsScreenSpaceUVScale" + id);
                        baseInvert = Shader.PropertyToID("_AdvancedDissolveCutoutStandardBaseInvert" + id);
                    }
                }

                public static IDs[] ids = new IDs[] { new IDs(0), new IDs(1), new IDs(2), new IDs(3), new IDs(4) };
                ...
                [Space(10)] public Texture2D map1;
                ...
                [Space(10)] public Texture2D map2;
                ...
                [Space(10)] public Texture2D map3;
                ...
                [Space(10)] public MapsBlendType mapsBlendType = MapsBlendType.Multiply;
                ...
                static public void UpdateLocalProperty(Material material, Property property, object value)
                {
                    ...
                    if (value == null && !(property == Property.Map1 || property == Property.Map2 ||
                                           property == Property.Map3))
                        return;
                ...
                static public void UpdateGlobalProperty(
                    AdvancedDissolve.AdvancedDissolveKeywords.GlobalControlID globalControlID, Property property,
                    object value)
                {
                    if (globalControlID == AdvancedDissolveKeywords.GlobalControlID.None)
                        return;
            ...
            public class Geometric
            {
                ...
                static void UpdateGlobal(AdvancedDissolve.AdvancedDissolveKeywords.GlobalControlID globalControlID,
                ...
                {
                    static public void XYZAxis(Material material, XYZAxis xyzAxis, XYZStyle xyzStyle, XYZSpace xyzSpace,
                        float axisRollout, Vector3 axisPosition)
                    {
                    ...
                    static public void Plane(Material material, AdvancedDissolveKeywords.CutoutGeometricCount countID,
                    ...
                    static public void Sphere(Material material, AdvancedDissolveKeywords.CutoutGeometricCount countID,
                    ...
                    static public void Cube(Material material, AdvancedDissolveKeywords.CutoutGeometricCount countID,
                    ...
                    static public void Capsule(Material material, AdvancedDissolveKeywords.CutoutGeometricCount countID,
                        Vector3 startPosition, Vector3 endPosition, float radius)
                    {
                    ...
                    static public void ConeSmooth(Material material,
                        AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 startPosition,
                        Vector3 endPosition, float radius)
                    {
                        //Same as Capsule
                ...
                {
                    static public void XYZAxis(AdvancedDissolveKeywords.GlobalControlID globalControlID,
                        XYZAxis xyzAxis, XYZStyle xyzStyle, XYZSpace xyzSpace, float axisRollout, Vector3 position)
                    {
                    ...
                    static public void Plane(AdvancedDissolveKeywords.GlobalControlID globalControlID,
                        AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 position, Vector3 normal)
                    {
                        switch (countID)
                        {
                            case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    ...
                    static public void Sphere(AdvancedDissolveKeywords.GlobalControlID globalControlID,
                        AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 position, float radius)
                    {
                        switch (countID)
                        {
                            case AdvancedDissolveKeywords.CutoutGeometricCount.One:
                    ...
                    static public void Cube(AdvancedDissolveKeywords.GlobalControlID globalControlID,
                        AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 position, Quaternion rotation,
                        Vector3 size)
                    {
                        size *= 0.5f;
                        Matrix4x4 TRS = Matrix4x4.TRS(position, rotation, Vector3.one).inverse;
                    ...
                    static public void Capsule(AdvancedDissolveKeywords.GlobalControlID globalControlID,
                        AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 startPosition,
                        Vector3 endPosition, float radius)
                    {
                        float height = Vector3.Distance(startPosition, endPosition);
                    ...
                    static public void ConeSmooth(AdvancedDissolveKeywords.GlobalControlID globalControlID,
                        AdvancedDissolveKeywords.CutoutGeometricCount countID, Vector3 startPosition,
                        Vector3 endPosition, float radius)
                    {
                        //Same as Capsule
        ...
        public class Edge
        {
            ...
            public class Base
            {
                ...
                [Space(10)] [ColorUsage(false)] public Color color = Color.green;
                    ...
                    object value)
                {
                    ...
                    switch (property)
                    {
                        ...
                        case Property.Color:
                            if (type == typeof(Color))
                                Shader.SetGlobalColor(ids[(int)globalControlID].color,
                                    QualitySettings.activeColorSpace == ColorSpace.Linear
                                        ? ((Color)value).linear
                                        : (Color)value);
                            break;
            ...
            public class AdditionalColor
            {
                class IDs
                {
                    ...
                    public IDs(int ID)
                    {
                        ...
                        colorTransparency =
                            Shader.PropertyToID("_AdvancedDissolveEdgeAdditionalColorTransparency" + id);
                        colorIntensity = Shader.PropertyToID("_AdvancedDissolveEdgeAdditionalColorIntensity" + id);

                        clipInterpolation =
                            Shader.PropertyToID("_AdvancedDissolveEdgeAdditionalColorClipInterpolation" + id);
                ...
                [Space(10)] [ColorUsage(false)] public Color color = Color.red;
                [Range(0, 1)] public float colorTransparency = 1;
                public float colorIntensity;

                [Space(10)] public bool clipInterpolation = false;
            ...
            public class GlobalIllumination
            {
                ...
                static public void UpdateGlobalProperty(
                    AdvancedDissolve.AdvancedDissolveKeywords.GlobalControlID globalControlID, float value)
                {
                    if (globalControlID == AdvancedDissolveKeywords.GlobalControlID.None)
                        return;
